package jwt.security.config.email;
...
public class EmailConfig {
    ...
    public JavaMailSender mailSender() {
        //JavaMailSender 의 구현체를 생성
        JavaMailSenderImpl mailSender = new JavaMailSenderImpl();
        // 속성 넣기
        mailSender.setHost("smtp.gmail.com"); // 이메일 전송에 사용할 SMTP 서버 호스트를 설정
        mailSender.setPort(587); // 587로 포트를 지정
        mailSender.setUsername("ghkdrbgur98@gmail.com"); //구글계정 넣기
        mailSender.setPassword("vmmk ojlz tegu gwhj"); //구글 앱 비밀번호를 넣습니다.
        ...
        mailSender.setJavaMailProperties(javaMailProperties); //mailSender에 우리가 만든 properties 넣음
